  ...
  const services: ServiceCard[] = [
    {
      ...
      icon: "🏗️",
      frontDescription: "Advanced structural health monitoring and assessment.",
      backDetails: [
    ...
    },
    {
      ...
      icon: "📡",
      frontDescription: "Comprehensive geotechnical instrumentation and monitoring.",
      backDetails: [
        "Slope stability monitoring",
        "Piezometer and water level monitoring",
        "Inclinometer and extensometer readings",
        "Load cell and strain gauge monitoring",
    ...
    },
    {
      ...
      icon: "🌡️",
      frontDescription: "Environmental parameter monitoring and reporting.",
      backDetails: [
    ...
    },
    {
      ...
      icon: "💻",
      frontDescription: "Advanced data analysis and visualization platforms.",
      backDetails: [
      ...
      <main className="min-h-screen bg-neutral-950">
        ...
        <section className="relative bg-gradient-to-br from-neutral-900 to-neutral-950 px-8 py-24 lg:px-16 lg:py-28">
          <div className="mx-auto max-w-7xl text-center">
            ...
            >
              State-of-the-art monitoring solutions for infrastructure and environmental management.
            </motion.p>
          </div>
        </section>
        ...
        <section className="bg-neutral-950 px-8 py-24 lg:px-16">
          <div className="mx-auto max-w-4xl">
            ...
            >
              <h3 className="mb-4 text-3xl font-bold text-white">Ensure project success with monitoring</h3>
              <p className="mb-8 text-lg text-neutral-300">
                Let us help you track performance and optimize your operations.
              </p>
              <a href="/#contato">

  ...
  const services: ServiceCard[] = [
    {
      ...
      icon: "⛏️",
      frontDescription: "Geological services for mining exploration and production.",
      backDetails: [
        "Geological mapping and interpretation",
        "Mineral resource estimation",
        "Ore body modeling and evaluation",
    ...
    },
    {
      title: "Mine Planning",
      icon: "📐",
      frontDescription: "Strategic mine planning and optimization services.",
      backDetails: [
    ...
    {
      title: "Geotechnical Mining",
      icon: "🏔️",
      frontDescription: "Specialized geotechnical engineering for mining operations.",
      backDetails: [
        "Slope stability analysis for open pits",
        "Underground excavation support design",
        "Tailings dam design and monitoring",
    ...
    },
    {
      title: "Mine Closure",
      icon: "🌱",
      frontDescription: "Sustainable mine closure and rehabilitation solutions.",
      backDetails: [
      ...
      <main className="min-h-screen bg-neutral-950">
        ...
        <section className="relative bg-gradient-to-br from-neutral-900 to-neutral-950 px-8 py-24 lg:px-16 lg:py-28">
          <div className="mx-auto max-w-7xl text-center">
            ...
            >
              Comprehensive mining geology and engineering solutions for sustainable operations.
            </motion.p>
          </div>
        </section>
        ...
        <section className="bg-neutral-950 px-8 py-24 lg:px-16">
          <div className="mx-auto max-w-4xl">
            ...
            >
              <h3 className="mb-4 text-3xl font-bold text-white">Optimize your mining operations</h3>
              <p className="mb-8 text-lg text-neutral-300">
                Partner with us for sustainable and efficient mining solutions.
              </p>
              <a href="/#contato">

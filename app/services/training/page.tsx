  ...
  const services: ServiceCard[] = [
    {
      ...
      icon: "📚",
      frontDescription: "Specialized technical training programs for professionals.",
      backDetails: [
        "Geotechnical engineering courses",
        "Hydrogeology and water resources",
        "Environmental management training",
        "Mining geology and operations",
    ...
    },
    {
      ...
      icon: "💻",
      frontDescription: "Professional software training for engineering applications.",
      backDetails: [
        "Geotechnical modeling software",
        "GIS and mapping applications",
        "Hydrological modeling tools",
        "Mining design software",
    ...
    },
    {
      ...
      icon: "🌍",
      frontDescription: "Hands-on field training and practical workshops.",
      backDetails: [
    ...
    },
    {
      ...
      icon: "🎯",
      frontDescription: "Tailored training programs for specific needs.",
      backDetails: [
      ...
      <main className="min-h-screen bg-neutral-950">
        ...
        <section className="relative bg-gradient-to-br from-neutral-900 to-neutral-950 px-8 py-24 lg:px-16 lg:py-28">
          <div className="mx-auto max-w-7xl text-center">
            ...
            >
              Professional development and specialized training for engineering excellence.
            </motion.p>
          </div>
        </section>
        ...
        <section className="bg-neutral-950 px-8 py-24 lg:px-16">
          <div className="mx-auto max-w-4xl">
            ...
            >
              <h3 className="mb-4 text-3xl font-bold text-white">Invest in your team's expertise</h3>
              <p className="mb-8 text-lg text-neutral-300">
                Develop technical skills and knowledge with our specialized training programs.
              </p>
              <a href="/#contato">
